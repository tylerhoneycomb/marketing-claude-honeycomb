...
_Last updated: 2026-05-15 (portfolio-scaling whitelist fix: `scaling-queue-read` + `scaling-log-read` routes added to `handleDashboardApi_` whitelist — first scheduled Tuesday cron run on 2026-05-12 failed with "Expecting value" JSON-parse error; fixed 2026-05-13 in PR #82; subsequent Tuesday runs are fully operational)_
