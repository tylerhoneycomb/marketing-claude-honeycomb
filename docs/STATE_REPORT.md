...
_Last updated: 2026-06-18 (documentation sync: corrected Code.js line count to ~6,500; updated autonomous-skill-execution section to reflect three paused workflows — daily-check, fatigue-monitor, creative-intelligence — paused 2026-06-08/2026-06-10 at Tyler's request)_
...
- **`agent-daily-check.yml`** _(shipped 2026-05-03)_ — **PAUSED 2026-06-08** at Tyler's request. Cron commented out; Apps Script fallback early-returns. `workflow_dispatch` still works. Was: daily cron at 8:30 AM ET (UTC 12:30).
- **`agent-fatigue-monitor.yml`** _(shipped 2026-05-03)_ — **PAUSED 2026-06-10** at Tyler's request. Cron commented out; Apps Script fallback early-returns. `workflow_dispatch` still works. Was: twice-weekly Mon + Thu 9:30 AM ET (UTC 13:30).
- **`agent-creative-intelligence.yml`** _(shipped 2026-05-05, validated end-to-end 2026-05-05)_ — **PAUSED 2026-06-08** at Tyler's request. Cron commented out; Apps Script fallback early-returns. `workflow_dispatch` still works (useful for on-demand cache refresh). Was: weekly Monday 10 AM ET (UTC 14:00). Three production runs on 2026-05-05 surfaced two distinct architectural findings that forced this skill's workflow to depart from the other agents' template:
