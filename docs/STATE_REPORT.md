...
_Last updated: 2026-05-28 (docs sync: corrected Code.js line count to ~6,450)_
...
1. **The "brain"** — a Google Apps Script program (~6,450 lines) that runs every day, pulls data from Meta and HubSpot, does the math, writes summaries, and proposes budget changes.
