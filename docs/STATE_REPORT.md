...
_Last updated: 2026-05-18 (doc sync: corrected Code.js line count to ~6,400; fixed skill count from "three" to six; fixed workflow count from "five" to seven; added portfolio-scaling to autonomous workflow patterns list)_
