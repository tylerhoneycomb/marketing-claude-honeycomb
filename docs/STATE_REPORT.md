...
_Last updated: 2026-06-08 (documentation audit: workflow count corrected to seven, portfolio-scaling added to second architectural pattern group, Apps Script fallback section updated to reflect all five triggerAgent* functions)_
...
The seven agent workflows fall into two architectural patterns:
