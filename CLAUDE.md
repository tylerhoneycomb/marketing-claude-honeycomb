...
- `.github/workflows/` — GitHub Actions CI/CD
  ...
  - `daily-data.yml` — Ad-level data pull. Active daily cron (`37 12 * * *` UTC, ~8:37 AM ET) since 2026-05-04, plus manual `workflow_dispatch` for backfills — see the Agent Data Constraints section below for the current schedule and the folded-in pipeline-health steps
